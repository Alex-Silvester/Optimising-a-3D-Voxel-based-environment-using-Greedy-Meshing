...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "7b6aead9fb88b3623e3b3725ebb42670cbe4c579"
  WORKING_DIRECTORY "C:/Users/alexs/Games_Tech/3rd year/CCTP/Project/Optimising a 3D, Voxel-based environment using Greedy Meshing/Dissertation project/out/build/x64-debug/_deps/glfw-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 7b6aead9fb88b3623e3b3725ebb42670cbe4c579")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"7b6aead9fb88b3623e3b3725ebb42670cbe4c579\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/alexs/Games_Tech/3rd year/CCTP/Project/Optimising a 3D, Voxel-based environment using Greedy Meshing/Dissertation project/out/build/x64-debug/_deps/glfw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/alexs/Games_Tech/3rd year/CCTP/Project/Optimising a 3D, Voxel-based environment using Greedy Meshing/Dissertation project/out/build/x64-debug/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
