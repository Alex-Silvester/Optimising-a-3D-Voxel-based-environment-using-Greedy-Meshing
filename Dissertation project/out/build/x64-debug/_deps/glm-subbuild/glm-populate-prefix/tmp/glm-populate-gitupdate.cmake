...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "0af55ccecd98d4e5a8d1fad7de25ba429d60e863"
  WORKING_DIRECTORY "C:/Users/alexs/Games_Tech/3rd year/CCTP/Project/Optimising a 3D, Voxel-based environment using Greedy Meshing/Dissertation project/out/build/x64-debug/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/alexs/Games_Tech/3rd year/CCTP/Project/Optimising a 3D, Voxel-based environment using Greedy Meshing/Dissertation project/out/build/x64-debug/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/alexs/Games_Tech/3rd year/CCTP/Project/Optimising a 3D, Voxel-based environment using Greedy Meshing/Dissertation project/out/build/x64-debug/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
